...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: 'Stop manually editing dynamic captions for hours. Here are the 5 tested AI tools real YouTube creators are using to automate viral Short-form videos.',
    date: 'August 1, 2026',
    readTime: '6 min read',
  ...
  },
  {
    ...
    excerpt: 'We tested both industry leaders for faceless YouTube channels, documentary narration, and multilingual video translation.',
    date: 'July 28, 2026',
    readTime: '7 min read',
  ...
  },
  {
    ...
    excerpt: 'A complete breakdown of the exact 4-tool AI stack used by high-revenue documentary and finance YouTube channels.',
    date: 'July 24, 2026',
    readTime: '8 min read',
