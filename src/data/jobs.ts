...
export const CREATOR_JOBS: CreatorJob[] = [
  ...
  {
    id: '5',
    company: 'TrueCrime AI Documentaries',
    title: 'Cinematic B-Roll Artist (Luma Dream Machine & Kling AI)',
    salary: '$3,500 - $5,000 / month',
    location: 'Remote (Worldwide)',
    type: 'Full-Time',
    category: 'AI Prompt Engineer',
    description:
      'Generate historically accurate, atmospheric 3D motion clips using Luma Dream Machine and Kling AI for our weekly 30-minute true crime video essays.',
    isFeatured: true,
    applyUrl: 'https://www.linkedin.com',
    postedDate: '2 days ago',
  },
  {
    id: '6',
    company: 'GlobalEdu Channels',
    title: 'Multilingual Video Localization Editor (Rask AI & HeyGen)',
    salary: '$2,000 - $3,000 / month',
    location: 'Remote (Worldwide)',
    type: 'Contract',
    category: 'Video Editor',
    description:
      'Translate and dub our top educational YouTube videos into Spanish, German, and Japanese using AI lip-syncing and voice cloning tools.',
    isFeatured: false,
    applyUrl: 'https://www.linkedin.com',
  ...
  },
  {
    ...
    title: 'Shorts Script & Hook Specialist (ChatGPT / Claude Prompts)',
    salary: '$100 / 10 scripts',
    location: 'Remote (Worldwide)',
    type: 'Per-Video',
    category: 'Scriptwriter',
    description:
      'Write rapid-fire 45-second TikTok scripts with curiosity loop hooks. Experience using custom GPT instructions for short-form retention required.',
    isFeatured: false,
    applyUrl: 'https://www.linkedin.com',
  ...
  {
    id: '8',
    company: 'PodCut Studios',
    title: 'Podcast Editor & Audio Enhancer (Descript / Adobe AI)',
    salary: '$40 - $75 / episode',
    location: 'Remote (Worldwide)',
    type: 'Contract',
    category: 'Video Editor',
    description:
      'Clean up audio recordings, remove filler words, and export polished multi-cam video podcasts using Descript Studio and Adobe Podcast AI.',
    isFeatured: false,
    applyUrl: 'https://www.linkedin.com',
