...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-zinc-200/80 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl transition-colors duration-300">
      ...
      {/* FUTURISTIC GLASS HAMBURGER DRAWER */}
      {isDrawerOpen && (
        <div className="fixed inset-x-0 top-16 z-50 border-b border-zinc-200 dark:border-white/10 bg-white/95 dark:bg-zinc-950/95 p-6 shadow-2xl backdrop-blur-2xl transition-all animate-in slide-in-from-top duration-300">
          <div className="mx-auto max-w-4xl">
            <div className="mb-4 flex items-center justify-between border-b border-zinc-200 dark:border-white/10 pb-3">
              ...
              <span className="text-[11px] text-zinc-500">
                MotionSites 3D Interactive Menu
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
              ...
              <Link
                ...
                className="group flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900/80 p-4 transition-all hover:border-purple-500 hover:bg-purple-500/10"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-purple-500/20 text-purple-500 dark:text-purple-400 group-hover:scale-110 transition-transform">
              ...
              <Link
                href="/compare"
                onClick={() => setIsDrawerOpen(false)}
                className="group flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900/80 p-4 transition-all hover:border-pink-500 hover:bg-pink-500/10"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-pink-500/20 text-pink-500 dark:text-pink-400 group-hover:scale-110 transition-transform">
              ...
              <Link
                href="/blog"
                onClick={() => setIsDrawerOpen(false)}
                className="group flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900/80 p-4 transition-all hover:border-blue-500 hover:bg-blue-500/10"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-500/20 text-blue-500 dark:text-blue-400 group-hover:scale-110 transition-transform">
              ...
              <Link
                href="/admin"
                onClick={() => setIsDrawerOpen(false)}
                className="group flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900/80 p-4 transition-all hover:border-amber-500 hover:bg-amber-500/10"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-500/20 text-amber-500 dark:text-amber-400 group-hover:scale-110 transition-transform">
