...
export function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-[100] border-b backdrop-blur-xl transition-[background-color,box-shadow,border-color] duration-300 ${
        scrolled
          ? 'border-white/10 bg-surface-0/90 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.55)]'
          : 'border-white/5 bg-surface-0/80'
      }`}
    >
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-2 px-4">
        ...
        <nav className="hidden items-center gap-1 xl:flex" aria-label="Main">
          <div className="relative z-[100]" ref={categoriesRef}>
            <button
            ...
            {categoriesOpen && (
              <div className="absolute start-0 mt-2 z-[110] w-[30rem] max-w-[90vw] rounded-xl border border-white/10 bg-surface-1 p-2 shadow-2xl backdrop-blur-2xl">
          ...
          <div className="relative z-[100]" ref={moreRef}>
            <button
            ...
            {moreOpen && (
              <div className="absolute end-0 mt-2 z-[110] grid w-56 grid-cols-1 gap-1 rounded-xl border border-white/10 bg-surface-1 p-2 shadow-2xl backdrop-blur-2xl">
                {moreLinks.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
        ...
        <div className="flex items-center gap-2">
          ...
          {user ? (
            <div className="relative hidden sm:block z-[100]" ref={accountRef}>
              <button
              ...
              {accountOpen && (
                <div className="absolute end-0 mt-2 z-[110] w-52 rounded-xl border border-white/10 bg-surface-1 p-2 shadow-2xl backdrop-blur-2xl">
