...
export const AIChatAssistant: React.FC<AIChatAssistantProps> = ({ tools }) => {
  ...
  const [lang, setLang] = useState<'en' | 'fa'>('en'); // ۱۰۰٪ انگلیسی به عنوان پیش‌فرض
  const [messages, setMessages] = useState<Message[]>([
    {
      sender: 'bot',
      text: "Hi! I'm your CreatorAI Hub assistant 🤖. Tell me what video or short you're making, and I'll match you with the best tested AI tool!",
    },
  ]);
