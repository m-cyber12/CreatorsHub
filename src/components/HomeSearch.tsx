...
const QUICK_CHIPS: { labelKey: string; query: string }[] = [
  { labelKey: 'chip1', query: 'caption generator for Shorts' },
  { labelKey: 'chip2', query: 'free voice cloning' },
  { labelKey: 'chip3', query: 'faceless' },
  { labelKey: 'chip4', query: 'podcast clipping' },
  { labelKey: 'chip5', query: 'b-roll' },
];
...
export function HomeSearch() {
  const t = useTranslations('components.homeSearch');
