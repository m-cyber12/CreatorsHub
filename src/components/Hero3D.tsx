...
import { Sparkles, Award, CheckCircle2, Zap, ArrowRight, Compass, ChevronDown } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="inline-flex items-center gap-2.5 rounded-full border border-purple-500/40 bg-purple-500/10 dark:bg-purple-950/50 px-4 py-1.5 text-xs font-bold text-purple-600 dark:text-purple-300 shadow-xl backdrop-blur-xl transition-all hover:border-purple-400 hover:scale-105 cursor-default">
            ...
            <span>Inspired by Bold Studio • MotionSites.ai 3D Edition</span>
          </div>

          {/* MASSIVE BOLD STUDIO EDITORIAL HEADLINE */}
          <h1 className="mt-8 font-extrabold tracking-tight text-zinc-900 dark:text-white text-5xl sm:text-7xl lg:text-8xl max-w-6xl leading-[1.02] uppercase font-sans">
            THE <span className="text-cinematic-neon">BOLD AI</span> STUDIO <br />
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            >
              <div className="flex items-center gap-2 rounded-2xl bg-white dark:bg-zinc-950 px-7 py-4 text-sm font-extrabold text-zinc-900 dark:text-white transition-colors group-hover:bg-zinc-100 dark:group-hover:bg-zinc-900">
                <Sparkles className="h-4 w-4 text-purple-500 dark:text-purple-400 animate-spin" style={{ animationDuration: '6s' }} />
            ...
            >
              <Compass className="h-4 w-4 text-purple-500 dark:text-purple-400" />
              <span>Explore 10+ Curated Tools</span>
            </a>
          </div>

          {/* 3D Cinematic Perspective Stage (MotionSites.ai Bold Studio Style) */}
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 items-center">
              ...
              <div className="cinematic-card animate-float-c1 rounded-3xl p-5 text-left hidden sm:block">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-bold text-emerald-500">10x Speed</span>
                </div>
                ...
                <p className="mt-3 text-xs font-semibold text-zinc-800 dark:text-zinc-200">1 video into 10 viral Shorts in 1 click</p>
                <p className="mt-1 text-[11px] text-zinc-500">Auto-captions &amp; virality score engine</p>
              </div>

              {/* Center Hero Spotlight Card */}
              <div className="cinematic-card rounded-[32px] p-6 text-left shadow-2xl sm:-translate-y-6 border-purple-500/50">
                <div className="flex items-center justify-between">
                ...
                <h3 className="mt-4 text-base font-extrabold text-zinc-900 dark:text-white">ElevenLabs Voice AI</h3>
                <p className="mt-1.5 text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
              ...
              <div className="cinematic-card animate-float-c2 rounded-3xl p-5 text-left hidden sm:block">
                ...
                <p className="mt-3 text-xs font-semibold text-zinc-800 dark:text-zinc-200">High-CTR YouTube thumbnail generator</p>
