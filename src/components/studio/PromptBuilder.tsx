...
import { Check, Copy, RefreshCcw, Sparkles, Loader2 } from 'lucide-react';
      ...
      <section className="studio-results" aria-live="polite">
        <div className="studio-results-heading">
          <div>
            ...
            <h2>{aiOutput ? t('readyHeading') : t('emptyHeading')}</h2>
          </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center p-12 text-center">
            ...
            <p className="text-sm font-bold text-zinc-300">{t('generatingLong')}</p>
          </div>
        ) : runError ? (
