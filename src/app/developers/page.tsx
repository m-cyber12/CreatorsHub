...
export const metadata: Metadata = {
  ...
  description: `Free read-only JSON API with ${ALL_TOOLS.length}+ curated AI video tools: names, categories, pricing, ratings, and tags. Rate-limited, no key required.`,
  alternates: { canonical: '/developers' },
};

const EXAMPLE = `curl "https://directory-ai-hub.vercel.app/api/v1/tools?q=voice%20cloning&pricing=Freemium&limit=5"`;
  ...
  "data": [
    {
      ...
      "detailPage": "https://directory-ai-hub.vercel.app/tool/elevenlabs"
    }
  ]
}`;
    ...
    <div className="min-h-screen bg-surface-0 text-white">
      ...
      <main className="mx-auto max-w-4xl px-4 py-14">
        ...
        <p className="mt-4 max-w-2xl text-sm text-zinc-400 leading-relaxed">
          ...
          editorial ratings, and tags. No API key required. Just add attribution with a link back to CreatorAI Hub.
        </p>
        ...
        <div className="mt-3 overflow-hidden rounded-2xl border border-white/10">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-white/5 bg-zinc-950/60 text-zinc-300">
              <tr><td className="px-4 py-3 font-mono text-purple-300">q</td><td className="px-4 py-3">string</td><td className="px-4 py-3">Search query — typo & synonym tolerant (e.g. <code>caption</code> also matches <code>subtitles</code>).</td></tr>
              <tr><td className="px-4 py-3 font-mono text-purple-300">category</td><td className="px-4 py-3">string</td><td className="px-4 py-3">One of: {CATEGORIES.filter((c) => c !== 'All').join(', ')}.</td></tr>
              <tr><td className="px-4 py-3 font-mono text-purple-300">pricing</td><td className="px-4 py-3">string</td><td className="px-4 py-3">Free · Freemium · Paid · Free Trial</td></tr>
              <tr><td className="px-4 py-3 font-mono text-purple-300">limit</td><td className="px-4 py-3">int</td><td className="px-4 py-3">1–100, default 50.</td></tr>
              <tr><td className="px-4 py-3 font-mono text-purple-300">offset</td><td className="px-4 py-3">int</td><td className="px-4 py-3">Pagination offset, default 0.</td></tr>
            </tbody>
          </table>
        </div>
