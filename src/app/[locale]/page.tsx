      ...
      <main id="main">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-sm leading-relaxed text-zinc-300 sm:text-lg">
              {content.homeHeroSub || (
                <>
                  ...
                  <span className="font-semibold text-accent-300">{t('heroSubPriceChecks')}</span> {t('heroSubFrom')}{' '}
        ...
        <section className="mx-auto max-w-6xl px-4 py-12">
          <div className="flex items-end justify-between gap-4">
            ...
            <Link href="/tools?sort=price-low" className="hidden text-sm font-semibold text-accent-300 transition-colors hover:text-accent-200 sm:block">
              {t('exploreCatalog')}
            </Link>
          </div>
