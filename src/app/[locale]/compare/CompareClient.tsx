      ...
      <div>
        ...
        <section className="relative overflow-hidden pt-12 pb-16 sm:pt-20 sm:pb-20 border-b border-white/10 text-center">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {/* 2026-08-12 audit fix: `sm:grid-cols-${cols}` was a runtime
                interpolation Tailwind never compiles → picker cards were
                stuck at one column on desktop. Keep the class names literal
                so the JIT can see them. */}
            <div
              className={`mt-10 mx-auto max-w-4xl grid grid-cols-1 gap-4 ${
