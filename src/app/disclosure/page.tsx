...
export const metadata: Metadata = {
  ...
  description:
    'Exactly how CreatorAI Hub is funded, which links earn commission, and the rules that keep scoring independent.',
  ...
  return (
    <div className="min-h-screen bg-surface-0 text-foreground">
      ...
      <main id="main" className="mx-auto max-w-2xl px-4 py-14">
        <h1 className="mb-6 text-3xl font-black tracking-tight">Affiliate disclosure</h1>
