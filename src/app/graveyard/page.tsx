...
export const metadata: Metadata = {
  title: 'The AI Video Tool Graveyard — Discontinued Tools & What to Use Instead',
  description: `${GRAVEYARD.length} AI video tools that shut down, why they died, whether you can get your data out, and the live replacement we recommend for each one. Checked continuously.`,
  alternates: { canonical: '/graveyard' },
  openGraph: {
    title: 'The AI Video Tool Graveyard',
    description: 'Tools that shut down, why, and what to use instead. We check every outbound link weekly.',
    url: '/graveyard',
    type: 'article',
  },
};
      ...
      <main id="main" className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-black tracking-tight sm:text-5xl">
            AI video tools that no longer exist
          </h1>
