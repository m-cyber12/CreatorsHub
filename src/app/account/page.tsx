      ...
      <main className="mx-auto max-w-7xl px-4 py-12">
        <div className="mb-10 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-600 to-pink-600 text-xl font-black">
          ...
          {user ? (
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 rounded-xl bg-purple-600 px-4 py-2.5 text-xs font-bold text-white hover:bg-purple-500 transition-colors"
            >
        ...
        <h2 className="mb-1 flex items-center gap-2 text-lg font-bold">
          <Bookmark className="h-4 w-4 text-purple-400" /> Saved Tools ({saved.length})
        </h2>
        ...
        {saved.length > 0 ? (
          ...
          <div className="flex flex-col items-center rounded-3xl border border-dashed border-white/10 bg-zinc-900/30 py-20 text-center">
            ...
            <Link href="/tools" className="mt-5 rounded-xl bg-purple-600 px-5 py-2.5 text-xs font-bold text-white hover:bg-purple-500 transition-colors">
