  ...
  return (
    <div className="min-h-screen bg-[#030305] text-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-14">
        ...
        <p className="text-xs text-zinc-500 mb-8">Last updated: August 3, 2026</p>

        <div className="space-y-8 text-sm leading-relaxed text-zinc-400">
          <section>
            <h2 className="text-lg font-bold text-white mb-2">1. Acceptance</h2>
            <p>By accessing CreatorAI Hub you agree to these terms. If you do not agree, please do not use the service.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-white mb-2">2. Nature of the service</h2>
            <p>
              CreatorAI Hub is an editorial directory. Tool listings, scores, and guides are informational opinions, not
          ...
          <section>
            ...
            <p>
              ...
              influences editorial scores. See our <a href="/disclosure" className="text-purple-400 underline">disclosure</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Site design, editorial content, and curation are © CreatorAI Hub. Tool names, logos, and screenshots belong to their
          ...
          <section>
            ...
            <p>Questions? Email <a href="mailto:hello@creatoraihub.com" className="text-purple-400 underline">hello@creatoraihub.com</a>.</p>
          </section>
        </div>
      </main>
      <Footer />
