...
const CAT = {
  ...
  VA: 'Voice & Audio', MU: 'Music & SFX', AV: 'AI Avatars',
  TD: 'Thumbnails & Design', SW: 'Scripting & Writing', TC: 'Transcription & Captions',
  SA: 'SEO & Analytics', AU: 'Automation', LS: 'Live & Streaming', TM: '3D & Motion',
};
const PRICE = { F: 'Free', FM: 'Freemium', P: 'Paid', FT: 'Free Trial' };

// Valid Unsplash photo IDs pool (verified working in existing dataset)
const IMGS = [
  '1626544827763-d516dce335e2','1590602847861-f357a9332bbc','1579783900882-c0d3dad7b119',
  '1618005182384-a83a8bd57fbe','1536240478700-b869070f9279','1550751827-4bd374c3f58b',
  '1550745165-9bc0b252726f','1551288049-bebda4e38f71','1517336714731-489bfd9ef1e4',
  '1526374965328-7f61d4dc18c5','1531746790731-6f132f5e6e9a','1507003211169-0a1dd7228f2d',
  '1478737270239-2f02b77ac6d5','1516321318423-f06f85e504b3','1519681393797-a1e27c513deb',
  '1557804500-7a4c3a9c8e0e','1598488035139-bdbb2231ce04','1511671782779-c97d3d27a1d4',
  '1455390589262-2fef7b1b5f13','1460925895917-afdab827c52f','1535016120720-40c6874c3b13',
  '1516035069371-29a1b244cc32','1558618666-fcd25c85f82f','1579783902614-a3fb3927b675',
  '1626785774573-4b7993143a09','1634017839464-5c339ebe3cb4','1557683316-973673baf926',
];
...
['Fliki','fliki.ai','VG','FM','$28/mo','Text to video with lifelike voiceovers','Turn scripts, blogs, or tweets into videos with 2,500+ AI voices in 80 languages, stock media, and subtitles.',['Text to Video','2500+ Voices','Blog to Video','Subtitles'],4.5,'80+ Languages','','2021-12-01'],
...
['Revid.ai','revid.ai','VR','P','$39/mo','Faceless viral video generator','Create faceless TikToks from a prompt — script, AI voice, captions, and stock or AI visuals in one click.',['Faceless','TikTok','One Click','AI Voice'],4.2,'Prompt to TikTok','N','2023-11-01'],
['Crayo','crayo.ai','VR','P','$19/mo','Clip farming at scale','Generate story-style shorts with gameplay backgrounds, AI voices, and captions — built for clip channels.',['Clip Farming','Gameplay BG','Story Shorts','Scale'],4.1,'Bulk Generation','','2023-10-01'],
['Zebracat','zebracat.ai','VR','FM','$19.5/mo','Text to viral marketing videos','Turn text prompts and blog posts into short marketing videos with AI scenes, voices, and music.',['Marketing','Text to Video','AI Scenes','Ads'],4.2,'Ad-Ready Output','N','2023-06-01'],
['Syllaby','syllaby.io','VR','P','$49/mo','Faceless content strategy engine','Plan, script, generate, and schedule faceless video content across platforms with AI topic research.',['Content Strategy','Faceless','Scheduling','Topic Research'],4.2,'Full Pipeline','','2023-02-01'],
...
// ===== Voice & Audio =====
['Rask AI','rask.ai','VA','P','$60/mo','Video translation & dubbing','Localize videos into 130+ languages with voice cloning, lip-sync, and multi-speaker detection — used by top educational channels.',['Dubbing','130+ Languages','Lip Sync','Localization'],4.7,'130+ Languages','F','2022-10-01'],
['Papercup','papercup.com','VA','P','Custom','Human-in-the-loop AI dubbing','Enterprise AI dubbing with professional translator review — powers localization for Bloomberg and Fremantle.',['Enterprise','Dubbing','QA Review','Broadcast'],4.4,'Broadcast Grade','','2017-01-01'],
['Dubverse','dubverse.ai','VA','FM','$15/mo','Instant online video dubbing','Dub videos into 60+ languages with lifelike voices, subtitle generation, and a collaborative editor.',['Dubbing','60+ Languages','Subtitles','Collaboration'],4.3,'Instant Dubs','','2021-08-01'],
...
['Camb.ai','camb.ai','VA','P','$25/mo','Speech translation in 140+ languages','MARS and BOLI models dub live sports and film into 140+ languages with emotion preservation.',['Dubbing','140+ Languages','Live Sports','Emotion'],4.3,'Live Dubbing','N','2023-01-01'],
['Vozo AI','vozo.ai','VA','P','$16/mo','AI video translator & lip sync','Translate, redub, and lip-sync videos with multi-speaker detection and script editing.',['Translation','Lip Sync','Multi-Speaker','Redub'],4.2,'Pro Lip Sync','','2023-05-01'],
// ===== Music & SFX =====
...
// ===== Scripting & Writing =====
['Gemini','gemini.google.com','SW','FM','$19.99/mo','Google\'s multimodal AI assistant','Research, script, and brainstorm with Google\'s frontier model — Deep Research and 1M-token context for long video projects.',['Multimodal','Deep Research','Long Context','Google'],4.7,'1M Token Context','FT','2023-12-06'],
['Perplexity','perplexity.ai','SW','FM','$20/mo','AI research with citations','Answer engine that researches topics with live web citations — perfect for fact-checking video scripts.',['Research','Citations','Fact-Check','Live Web'],4.7,'Cited Answers','F','2022-08-01'],
...
['Grok','x.ai','SW','FM','$30/mo','xAI\'s real-time assistant','Frontier reasoning model with live X data, image generation, and unfiltered research for trend-aware creators.',['Real-time Trends','Reasoning','X Data','Image Gen'],4.5,'Live Trend Data','T','2023-11-04'],
['DeepSeek','deepseek.com','SW','F','','Open-source frontier reasoning','Free frontier-level reasoning and writing model — R1 rivals paid models for script logic and research.',['Free','Open Source','Reasoning','Research'],4.5,'Free Frontier AI','T','2023-11-29'],
...
['Morningfame','morningfame.com','SA','P','$4.90/mo','Beginner-friendly YouTube analytics','Invite-only analytics that grades your channel growth and guides keyword strategy step by step.',['Analytics','Keyword Strategy','Beginner','Grades'],4.3,'Guided Strategy','','2017-01-01'],
...
['NotebookLM','notebooklm.google.com','SW','FM','$19.99/mo','AI research & podcast notebook','Upload sources and get grounded summaries, study guides, and viral Audio Overview podcasts from your own documents.',['Research','Audio Overviews','Grounded','Sources'],4.6,'Audio Overviews','TN','2023-07-12'],
// ===== Live & Streaming =====
...
const tools = ROWS.map((r, i) => {
  ...
  return {
    ...
    coverImage: `https://images.unsplash.com/photo-${IMGS[i % IMGS.length]}?w=800&auto=format&fit=crop&q=80`,
    category: CAT[cat],
...
export const EXTENDED_TOOLS: Tool[] = ${JSON.stringify(tools, null, 2)};
`;
